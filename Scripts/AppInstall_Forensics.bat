...
start /wait "" "C:\Program Files\7-Zip\7z.exe" x "C:\WSB\Apps\networkminer.zip" -o"C:\Tools\NetworkMiner\" -y >nul
...
start /wait "" "C:\Program Files\7-zip\7z.exe" x "C:\WSB\Apps\Johnny.zip" -o"C:\Temp\Johnny" -y >nul
...
start "" "C:\Program Files\7-Zip\7z.exe" x "C:\WSB\Apps\CyberChef.zip" -o"C:\Tools\CyberChef" -y >nul
echo CyberChef Added to Tools >> %UserProfile%\Documents\StartupChanges.txt

start "" "C:\Program Files\7-zip\7z.exe" x "C:\WSB\Apps\QPDF.zip" -o"C:\Tools\QPDF\" -y >nul
